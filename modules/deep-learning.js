...
(function () {
  ...
  function updateProgress() {
    ...
    try {
      const tKey = K("deep_learning_quiz_total_v1");
      const dKey = K("deep_learning_quiz_done_v1");
    ...
    try {
      if (
        ...
        const cKey = K("deep_learning_completed_v1");
        ...
        try {
          const actKey = K("home_activity_logged_deep_learning_v1");
